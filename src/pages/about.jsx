  ...
  return (
    <Layout>
      <section style={{width: '100%', maxWidth: '640px', margin: '0 auto'}}>
        ...
        <p>В работе я предпочитаю использовать React и его инфраструктуру. При написании компонентов использую методологию БЭМ. Последнее время я заинтересовался JAM стеком, в частности Gatsby, который основан на React. Этот сайт на Gatsby.</p>
